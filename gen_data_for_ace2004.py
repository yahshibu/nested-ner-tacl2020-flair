...
def batch_stat(batches: Tuple[List[List[List[str]]],
...
if __name__ == "__main__":
    reader = Reader()
    reader.read_all_data("./data/ace2004/", "ace2004.train", "ace2004.dev", "ace2004.test")
    ...
    reader.gen_vectors_google_news_word2vec(config.embed_path)
